...
import { McpIncomingMessageNotification, McpOutgoingMessageNotification } from '@fondamenta/mcp-core/dist/types-mcp-notifications.js';
...
export type HarnessNotification =
  ...
  | DueTodoNotification
  | McpIncomingMessageNotification
